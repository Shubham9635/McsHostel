...
const notification_stream_service_1 = require("../services/notification-stream.service");
...
function parseNotificationDetails(n) {
    let related_type = 'system';
...
router.get('/stream', (req, res) => {
    ...
    notification_stream_service_1.notificationStreamService.addClient(req.user.id, res);
});
